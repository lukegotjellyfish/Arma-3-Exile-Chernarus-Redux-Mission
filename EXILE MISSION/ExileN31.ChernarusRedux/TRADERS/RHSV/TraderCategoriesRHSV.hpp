	...
	class RHS_SOV_RU_Tanks
	{
		...
		items[] =
		{
			...
			//ANCHOR T-80UM
			"rhs_t80um",
			//ANCHOR T-90 (obr. 1992g.)
			"rhs_t90_tv",
			//ANCHOR T-90A (obr. 2006g.)
			"rhs_t90a_tv",
			//ANCHOR T-90AM (obyekt 188AM)
			"rhs_t90am_tv",
			//ANCHOR T-90SA (obr. 2004g.)
			"rhs_t90saa_tv",
			"rhs_t90sab_tv",
			//ANCHOR T-90SM (obyekt 188SM)
			"rhs_t90sm_tv"
		};
	};
	...
	class RHS_US_Cars
	{
		...
		items[] =
		{
			...
			//ANCHOR M966A1 (M220A2)
			//NOTE TOW Humvee
			"rhsusf_m966_d",
			"rhsusf_m966_w",
			//ANCHOR M998A1 (2D/Covered)
	...
	class RHS_US_Transport
	{
		name = "RHS US Transport";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemacc_ca.paa";
		items[] =
		{
			//ANCHOR M1025A1 (M2)
	...
	class RHS_US_Artillery
	{
		name = "RHS US Artillery";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemacc_ca.paa";
		items[] =
		{
			//ANCHOR M109A6
	...
	class RHS_US_Choppers
	{
		name = "RHS US Helicopters";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemacc_ca.paa";
		items[] =
		{
			//ANCHOR AH-1Z
