...
class ejikConvou
{
	...
	class ejikConvouVehicle
	{
		class ejikConvouVehicleOne
		{
			...
			vehicleMarkerName = "Рыбаки"; // Название маркера. Можно оставить просто пустым
			convoyAlertVehicle = 1; /* 1 - Отображать сообщение о том что появился конвой. 0 - не отображать. */
			vehicleAlertTitle = "ВНИМАНИЕ"; // Заголовок оповещения
			vehicleAlertContent = "Отряд безумных ботов ищет добычу. Будьте аккуратно на дороге."; // Текст опопвещения
			speedLimitedVehicle = 50; /* Ограничение скорости техники. Если у вас будет разная техника, то чтоб она ехала с одинаковой скоростью */
		...
		class ejikConvouVehicleTwo
		{
			...
			vehicleMarkerName = "Злые собаки"; // Название маркера. Можно оставить просто пустым
			convoyAlertVehicle = 1; /* 1 - Отображать сообщение о том что появился конвой. 0 - не отображать. */
			vehicleAlertTitle = "ВНИМАНИЕ"; // Заголовок оповещения
			vehicleAlertContent = "Отряд безумных ботов ищет добычу. Будьте аккуратно на дороге."; // Текст опопвещения
			speedLimitedVehicle = 50; /* Ограничение скорости техники. Если у вас будет разная техника, то чтоб она ехала с одинаковой скоростью */
		...
		class ejikConvouVehicleThree
		{
			...
			convoyMarkerVehicle = 1; /* 1 - Отображать конвой на карте. 0 - не отображать на карте. */
			vehicleMarkerColor = "ColorBlack"; // Цвет маркера на карте. Доступные цвета ColorGrey, ColorBlack, ColorRed, ColorBrown, ColorOrange, ColorYellow, ColorKhaki, ColorGreen, ColorBlue, ColorPink, ColorWhite
			vehicleMarkerName = "Рыбаки 2"; // Название маркера. Можно оставить просто пустым
			convoyAlertVehicle = 1; /* 1 - Отображать сообщение о том что появился конвой. 0 - не отображать. */
			vehicleAlertTitle = "ВНИМАНИЕ"; // Заголовок оповещения
			vehicleAlertContent = "Отряд безумных ботов ищет добычу. Будьте аккуратно на дороге."; // Текст опопвещения
			speedLimitedVehicle = 50; /* Ограничение скорости техники. Если у вас будет разная техника, то чтоб она ехала с одинаковой скоростью */
