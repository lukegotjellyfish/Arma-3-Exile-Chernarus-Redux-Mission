...
/* Mission System Settings */
	...
	DMS_playerNearRadius				= 150;						// How close a player has to be to a mission in order to satisfy the "playerNear" mission requirement (can be customized per mission).
...
/* DonkeyPunchDMS Custom Side Factions */
	...
	DMS_ai_skill_static				= [["aimingAccuracy",0.20],["aimingShake",0.70],["aimingSpeed",0.55],["spotDistance",0.50],["spotTime",0.50],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",1.00]];	// Static AI Skills
	...
	DMS_AI_destroyStaticWeapon			= 0;						// Whether or not to destroy static HMGs after AI death.
	...
	DMS_sniper_bipod_chance				= 70;						// Percentage chance that a Sniper Class AI will get a bipod
