...
class CfgExileArsenal
{
	...
	#include "TRADERS\NIAW\ItemListNIAW.hpp"
...
class CfgExileCustomCode
{
	...
	*/
	//Wood->CarInv
	ExileServer_object_tree_network_chopTreeRequest = "Custom\WoodInCar\ExileServer_object_tree_network_chopTreeRequest.sqf";

	//world spawnVehicles (With inventory)
...
class CfgTerritories
{
	...
	maximumNumberOfTerritoriesPerPlayer = 20;
...
class CfgTraderCategories
{
	...
	#include "TRADERS\NIAW\TraderCategoriesNIAW.hpp"
...
class CfgXM8
{
	extraApps[] = {"ExAd_JX","ExAd_Info","ExAd_CHVD","ExAd_VG","BRAmaRecipes","BaseMarker","ExAd_Quad","ExAd_Unit"};
